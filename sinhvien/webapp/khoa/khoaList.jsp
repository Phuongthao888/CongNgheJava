...
<body>
	...
	<div class="card-add">
		...
		<a href="addKhoa.jsp"> &nbsp&nbsp Thêm khoa</a>
	</div>
	            ...
	            <div class="col bottom">
	                <div class="card" style="width: 400px;">
	                    <div class="card-body card-color">
	                        ...
	                        <hr>
	                        <a href="detailsKhoaServlet?code=${khoa.makhoa}"  class="btn btn-secondary">Chi tiết</a>
	                        <a href="editKhoaServlet?code=${khoa.makhoa}" class="btn btn-info">Cập nhật</a>
	                        <a href="deleteKhoa.jsp?code=${khoa.makhoa}&tenkhoa=${khoa.tenkhoa}" class="btn btn-danger">Xóa</a>
	                    </div>
	                </div>
	            </div>
	        </c:forEach>
