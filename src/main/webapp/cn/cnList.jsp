...
<body>
	...
	<div class="card-add">
		...
		<a href="${pageContext.request.contextPath}/newCNServlet"> &nbsp&nbsp Thêm chuyên ngành</a>
	</div>
	            ...
	            <div class="col bottom">
	                <div class="card" style="width: 400px;">
	                    <div class="card-body card-color">
	                        ...
	                        <h6 class="card-subtitle mb-2 text-muted">Tên chuyên ngành: ${cn.tencn}</h6>
	                        <h6 class="card-subtitle mb-2 text-muted">Mã khoa: ${cn.khoaFK.makhoa}</h6>
	                        <hr>
	                        <a href="editCNServlet?code=${cn.macn}" class="btn btn-info">Cập nhật</a>
	                        <a href="./cn/deleteCN.jsp?code=${cn.macn}&tenchuyennganh=${cn.tencn}" class="btn btn-danger">Xóa</a>
	                    </div>
	                </div>
	            </div>
	        </c:forEach>
