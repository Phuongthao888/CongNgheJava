	...
	<div class="viewport">
		...
		<div class="container-fluid">
		  <section class="container">
		    <header>Cập nhật thông tin về khoa</header>
		    <form class="row g-3" action="${pageContext.request.contextPath}/editKhoaServlet"  method="post">
		      <div class="col-md-12">
		        <label for="makhoa" class="form-label">Mã khoa</label>
		        <input type="text" class="form-control" value="${param.code}" name="makhoa" readonly>
		      </div>
		      <div class="col-md-12">
