...
<body>
	...
	<!-- TABLE CONTENT -->
	<div id="tableListContent" style="display: none; margin-top: 20px;">
	...
	<script>
		...
		document
				...
				.addEventListener(
						...
						function() {
							// Toggle the display property of the content container
							var tableListContent = document
									.getElementById('tableListContent');
							tableListContent.style.display = (tableListContent.style.display === 'none' || tableListContent.style.display === '') ? 'block'
									: 'none';

							// Disable the icon list toggle button
